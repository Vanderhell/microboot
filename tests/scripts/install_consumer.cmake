...
if(DEFINED MBOOT_C_FLAGS AND NOT MBOOT_C_FLAGS STREQUAL "")
    list(APPEND _consumer_configure_args -DCMAKE_C_FLAGS=${MBOOT_C_FLAGS})
endif()
if(DEFINED MBOOT_CXX_FLAGS AND NOT MBOOT_CXX_FLAGS STREQUAL "")
    list(APPEND _consumer_configure_args -DCMAKE_CXX_FLAGS=${MBOOT_CXX_FLAGS})
endif()
if(DEFINED MBOOT_EXE_LINKER_FLAGS AND NOT MBOOT_EXE_LINKER_FLAGS STREQUAL "")
    list(APPEND _consumer_configure_args -DCMAKE_EXE_LINKER_FLAGS=${MBOOT_EXE_LINKER_FLAGS})
endif()
